...
//Binarização não estava funcionando e não encontrei o problema,
//colegas testaram o mesmo código e funcionou mas pra mim não deu,
//Redimencionar, não funcionando o 1/2 e 1/4, me baseei na mesma fórmula
//do 2x e 4x mas não foi.

//Observações:
//Grande parte do código parde de códigos disponibilizados em aula e 
//trabalhos com o canvas da internet sobre os assuntos que foram solicitados,
//no mais, houve alguma adaptações.
...
let suavizacaoMediana = function() {
    ...
    for (var i = 1; i < img.width+1; i++) {       
        for (var j = 1; j < img.height+1; j++) {   
            ...
            //Funcionamento igual aprendido em aula, pegar o centro e fazer as
            //operações com os outros 8 pixeis que ficam em volta.
...
let suavizacaoMedia = function() {
    ...
    for (var i = 0; i < img.width; i++) {
        for (var j = 0; j < img.height; j++) {
            ...
            //Mesmo funcionamento, praticamente do anterior.
            //Somente o cálculo final que é diferente.
